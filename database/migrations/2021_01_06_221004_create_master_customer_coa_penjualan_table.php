...
class CreateMasterCustomerCoaPenjualanTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('master_customer_coa_penjualan', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('master_customer_coa_penjualan');
    }
}
