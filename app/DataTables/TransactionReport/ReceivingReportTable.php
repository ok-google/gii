...
class ReceivingReportTable extends Table
{
    ...
    private function query(Request $request)
    {
        $model = Receiving::where('receiving.status', Receiving::STATUS['ACC'])
            ...
            ->selectRaw('master_supplier.name as supplier, ppb.code as ppb, receiving_detail.description, master_products.code as sku, master_products.name as product, ppb_detail.quantity as ppb_qty, receiving_detail.total_quantity_ri as ri_qty, receiving_detail.total_quantity_colly as colly_qty, ppb_detail.total_price_idr / ppb_detail.quantity as hpp');
