...
{
    protected $fillable = [
        'receiving_id', 'ppb_id', 'ppb_detail_id', 'product_id', 'quantity', 'total_quantity_ri', 'total_quantity_colly', 'delivery_cost', 'no_container' ,'description', 'total_ri_idr', 'grand_total'
    ];
