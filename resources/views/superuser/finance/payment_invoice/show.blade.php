...
<div class="block">
  <div class="block-header block-header-default">
    <h3 class="block-title">Show Cash/Bank Payment (Inv)</h3>
  </div>
  <div class="block-content">
    <div class="form-group row">
      <label class="col-md-3 col-form-label text-right" for="code">Code</label>
      <div class="col-md-7">
        <div class="form-control-plaintext">{{ $payment_invoice->code }}</div>
      </div>
    </div>
    <div class="form-group row">
      <label class="col-md-3 col-form-label text-right">Select Date</label>
      <div class="col-md-7">
        <div class="form-control-plaintext">{{ \Carbon\Carbon::parse($payment_invoice->select_date)->format('d/m/Y') }}</div>
      </div>
    </div>
    <div class="form-group row">
      <label class="col-md-3 col-form-label text-right" for="coa">Account</label>
      <div class="col-md-7">
        <div class="form-control-plaintext">{{ $payment_invoice->coa->name }}</div>
      </div>
    </div>
    <div class="form-group row">
      <label class="col-md-3 col-form-label text-right" for="supplier">Supplier</label>
      <div class="col-md-7">
        <div class="form-control-plaintext">{{ $payment_invoice->supplier->name }}</div>
      </div>
    </div>
    <div class="form-group row">
      <label class="col-md-3 col-form-label text-right" for="address">Address</label>
      <div class="col-md-7">
        <div class="form-control-plaintext">{{ $payment_invoice->supplier->address }}</div>
      </div>
    </div>
    <div class="form-group row">
      <label class="col-md-3 col-form-label text-right" for="note">Note</label>
      <div class="col-md-7">
        <div class="form-control-plaintext">{{ $payment_invoice->description }}</div>
      </div>
    </div>
    <div class="form-group row">
      <label class="col-md-3 col-form-label text-right" for="status">Status</label>
      <div class="col-md-7">
        <div class="form-control-plaintext">{{ $payment_invoice->status() }}</div>
      </div>
    </div>
  </div>
  <div class="block-content">
