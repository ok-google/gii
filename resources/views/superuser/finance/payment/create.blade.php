...
<form class="ajax" data-action="{{ route('superuser.finance.payment.store') }}" data-type="POST" enctype="multipart/form-data">
  <div class="block">
    <div class="block-header block-header-default">
      <h3 class="block-title">Create Cash/Bank Payment</h3>
    </div>
