...
<div class="block">
  <div class="block-header block-header-default">
    <h3 class="block-title">Show Cash/Bank Receipt</h3>
  </div>
  <div class="block-content">
    <div class="form-group row">
      <label class="col-md-3 col-form-label text-right" for="code">Transaction</label>
      <div class="col-md-7">
        <div class="form-control-plaintext">{{ $receipt->code }}</div>
      </div>
    </div>
    <div class="form-group row">
      <label class="col-md-3 col-form-label text-right">Select Date</label>
      <div class="col-md-7">
        <div class="form-control-plaintext">{{ \Carbon\Carbon::parse($receipt->select_date)->format('d/m/Y') }}</div>
      </div>
    </div>
  </div>
  <div class="form-group row">
