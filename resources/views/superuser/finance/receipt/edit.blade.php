...
<nav class="breadcrumb bg-white push">
  ...
  <a class="breadcrumb-item" href="{{ route('superuser.finance.receipt.index') }}">Cash/Bank Receipt</a>
  <span class="breadcrumb-item active">Edit</span>
</nav>
<div id="alert-block"></div>

<form class="ajax" data-action="{{ route('superuser.finance.receipt.update', $receipt->id) }}" data-type="POST" enctype="multipart/form-data">
  <input type="hidden" name="_method" value="PUT">
  <input type="hidden" name="ids_delete" value="">
  <div class="block">
    <div class="block-header block-header-default">
      <h3 class="block-title">Edit Cash/Bank Receipt</h3>
    </div>
    <div class="block-content">
      <div class="form-group row">
        <label class="col-md-3 col-form-label text-right" for="transaction">Transaction <span class="text-danger">*</span></label>
        <div class="col-md-4">
          <input type="text" class="form-control" id="transaction" name="transaction" onkeyup="nospaces(this)" value="{{ $receipt->code }}" readonly>
        </div>
      </div>
      <div class="form-group row">
        <label class="col-md-3 col-form-label text-right" for="select_date">Select Date <span class="text-danger">*</span></label>
        <div class="col-md-4">
          <input type="date" class="form-control" id="select_date" name="select_date" value="{{ $receipt->select_date ? date('Y-m-d', strtotime($receipt->select_date)) : '' }}">
        </div>
      </div>
    </div>
    <hr>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="#" class="row-delete-debet">
                        <button type="button" class="btn btn-sm btn-circle btn-alt-danger" title="Delete"><i class="fa fa-trash"></i></button>
                      </a>
                    </td>
                  </tr>
              @endforeach
            ...
            <tbody>
              @foreach ($receipt_credit as $item)
                  <tr>
                    ...
                    <td>
                      <input type="number" class="form-control" name="total_credit_detail[]" value="{{ $item->total }}" required>
                    </td>
                    <td>
                      <a href="#" class="row-delete-credit">
                        <button type="button" class="btn btn-sm btn-circle btn-alt-danger" title="Delete"><i class="fa fa-trash"></i></button>
                      </a>
                    </td>
                  </tr>
    ...
    <div class="block-content">
      <div class="form-group row pt-30">
        <div class="col-md-6">
          <a href="{{ route('superuser.finance.receipt.index') }}">
