...
<form class="ajax" data-action="{{ route('superuser.finance.receipt.store') }}" data-type="POST" enctype="multipart/form-data">
  <div class="block">
    <div class="block-header block-header-default">
      <h3 class="block-title">Create Cash/Bank Receipt</h3>
    </div>
    <div class="block-content">
      <div class="form-group row">
        <label class="col-md-3 col-form-label text-right" for="transaction">Transaction <span class="text-danger">*</span></label>
        <div class="col-md-4">
          <input type="text" class="form-control" id="transaction" name="transaction" onkeyup="nospaces(this)">
        </div>
      </div>
      <div class="form-group row">
      ...
      <div class="form-group row">
        <label class="col-md-3 col-form-label text-right" for="note_receipt">Description Transaction</label>
        <div class="col-md-4">
          <input type="text" class="form-control" id="note_receipt" name="note_receipt">
        </div>
      </div>
    </div>
    <hr>
