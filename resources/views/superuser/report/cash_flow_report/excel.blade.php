<html>
  ...
  <body style="font-size: 0.7em;">
    ...
    <table class="mt-25">
      ...
      <tr>
        <td class="text-left" width="50" colspan="3">
          <b>Revenue :</b>
        </td>
      </tr>
      @foreach ($report['B'] as $item)
        @if ($item->total_debet != null && $item->total_debet != 0)
          <tr>
            <td class="text-left" width="50">{{ $loop->iteration }}. {{ $item->coa->name }}</td>
        ...
        @if ($item->total_credit != null && $item->total_credit != 0)
          <tr>
            <td class="text-left" width="50">{{ $loop->iteration }}. {{ $item->coa->name }}</td>
            <td class="text-left" width="50">({{ 'Rp. '.number_format($item->total_credit, 2, ",", ".") }})</td>
            <td class="text-left" width="50"></td>
          </tr>
        @endif
      @endforeach
      <tr>
        ...
        <td class="text-left" width="50">{{ 'Rp. '.number_format($report['B']->sum('total_debet') - $report['B']->sum('total_credit'), 2, ",", ".") }}</td>
      </tr>
      ...
      <tr>
        ...
        <td class="text-left border-top" width="50"></td>
        <td class="text-left" width="50">{{ 'Rp. '.number_format($report['C']->sum('total_debet') - $report['C']->sum('total_credit'), 2, ",", ".") }}</td>
      </tr>
      ...
      <tr>
        ...
        <td class="text-left border-top" width="50"></td>
        <td class="text-left" width="50">{{ 'Rp. '.number_format($report['D']->sum('total_debet') - $report['D']->sum('total_credit'), 2, ",", ".") }}</td>
      </tr>
      ...
      <tr>
        ...
        <td class="text-left" width="50"></td>
        <td class="text-left border-top" width="50">{{ 'Rp. '.number_format($report['E'], 2, ",", ".") }}</td>
      </tr>
      <tr>
        <td class="text-left" width="50">
          <b>Cash Interval</b>
        </td>
        <td class="text-left" width="50">{{ 'Rp. '.number_format($report['F'], 2, ",", ".") }}</td>
        <td class="text-left" width="50"></td>
      </tr>
    </table>
  </body>
