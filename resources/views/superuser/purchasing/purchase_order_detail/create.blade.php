...
<div class="block">
  ...
  <div class="block-content">
    <form class="ajax" data-action="{{ route('superuser.purchasing.purchase_order.detail.store', $purchase_order->id) }}" data-type="POST" enctype="multipart/form-data">
      ...
      <div class="form-group row">
        <label class="col-md-3 col-form-label text-right" for="sku">SKU <span class="text-danger">*</span></label>
        <div class="col-md-7">
      ...
      <div class="form-group row">
        ...
        <div class="col-md-4">
          <input type="number" class="form-control" id="quantity" name="quantity" min="0" value="0" step="1">
        </div>
      </div>
      <div class="form-group row">
        <label class="col-md-3 col-form-label text-right" for="unit_price">Unit Price (RMB)</label>
        <div class="col-md-4">
          <input type="number" class="form-control" id="unit_price" name="unit_price" min="0" value="0" step="any">
        </div>
      </div>
      <div class="form-group row">
        <label class="col-md-3 col-form-label text-right" for="local_freight_cost">Local Freight Cost (RMB)</label>
        <div class="col-md-4">
          <input type="number" class="form-control" id="local_freight_cost" name="local_freight_cost" min="0" value="0" step="any">
        </div>
      </div>
      <div class="form-group row">
        <label class="col-md-3 col-form-label text-right" for="komisi">Komisi (RMB)</label>
        <div class="col-md-4">
          <input type="number" class="form-control" id="komisi" name="komisi" min="0" value="0" step="any">
        </div>
      </div>
      <div class="form-group row">
