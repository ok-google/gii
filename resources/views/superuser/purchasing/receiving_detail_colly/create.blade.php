...
<div class="block">
  ...
  <div class="block-content">
    <form class="ajax" data-action="{{ route('superuser.purchasing.receiving.detail.colly.store', [$receiving->id, $receiving_detail->id]) }}" data-type="POST" enctype="multipart/form-data">
