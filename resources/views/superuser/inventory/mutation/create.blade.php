...
<form class="ajax" data-action="{{ route('superuser.inventory.mutation.store') }}" data-type="POST" enctype="multipart/form-data">
  <div class="block">
    <div class="block-header block-header-default">
      <h3 class="block-title">Create Mutation</h3>
    </div>
    <div class="block-content">
      <div class="form-group row">
        <label class="col-md-3 col-form-label text-right" for="code">Code <span class="text-danger">*</span></label>
        <div class="col-md-7">
          <input type="text" class="form-control" id="code" name="code" onkeyup="nospaces(this)" value="{{ App\Repositories\MutationRepo::generateCode() }}" readonly>
        </div>
      </div>
      <div class="form-group row">
              ...
              if (json.msg == '') {
                ...
                if (duplicate == 1) {
                  ...
                  table.row.add([
                    ...
                    json.data.sku,
                    json.data.name,
                    '<input type="hidden" class="form-control" name="id[]" value="'+json.data.id+'">'+json.data.quantity,
