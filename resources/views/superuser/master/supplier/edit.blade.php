...
<nav class="breadcrumb bg-white push">
  ...
  <a class="breadcrumb-item" href="{{ route('superuser.master.supplier.index') }}">Supplier</a>
...
<div class="block">
  ...
  <div class="block-content">
    <form class="ajax" data-action="{{ route('superuser.master.supplier.update', $supplier) }}" data-type="POST" enctype="multipart/form-data">
      <input type="hidden" name="_method" value="PUT">
      <div class="form-group row">
        <label class="col-md-3 col-form-label text-right" for="code">Code <span class="text-danger">*</span></label>
        <div class="col-md-7">
          <input type="text" class="form-control" id="code" name="code" onkeyup="nospaces(this)" value="{{ $supplier->code }}" readonly>
        </div>
      </div>
      <div class="form-group row">
      ...
      <div class="form-group row">
        ...
        <div class="col-md-7">
          <select class="js-select2 form-control" id="provinsi" name="provinsi" data-placeholder="Select Provinsi" data-value="{{ $supplier->provinsi }}">
            <option></option>
          </select>
      ...
      <div class="form-group row">
        ...
        <div class="col-md-7">
          <select class="js-select2 form-control" id="kota" name="kota" data-placeholder="Select Kota" data-value="{{ $supplier->kota }}">
            <option></option>
          </select>
      ...
      <div class="form-group row">
        ...
        <div class="col-md-7">
          <select class="js-select2 form-control" id="kecamatan" name="kecamatan" data-placeholder="Select Kecamatan" data-value="{{ $supplier->kecamatan }}">
            <option></option>
          </select>
      ...
      <div class="form-group row">
        ...
        <div class="col-md-7">
          <select class="js-select2 form-control" id="kelurahan" name="kelurahan" data-placeholder="Select Kelurahan" data-value="{{ $supplier->kelurahan }}">
            <option></option>
          </select>
      ...
      <div class="form-group row">
        ...
        <div class="col-md-7">
          <input type="text" class="form-control" id="zipcode" name="zipcode" value="{{ $supplier->zipcode }}">
        </div>
      </div>
      <div class="form-group row">
      ...
      <div class="form-group row">
        ...
        <div class="col-md-7">
          <input type="text" class="form-control" id="owner_name" name="owner_name" value="{{ $supplier->owner_name }}">
        </div>
      </div>
      <hr>
      <div class="block-header">
        <h3 class="block-title">COA Setting</h3>
      </div>
      <div class="form-group row">
