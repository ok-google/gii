...
<div class="block">
  ...
  <div class="block-content">
    ...
    <div class="row">
      <label class="col-md-3 col-form-label text-right">Customer Type</label>
      <div class="col-md-7">
        <div class="form-control-plaintext">{{ $customer_type->name }}</div>
      </div>
    </div>
    <div class="row">
      <label class="col-md-3 col-form-label text-right">Grosir Address</label>
      <div class="col-md-7">
        <div class="form-control-plaintext">
          @if ($customer_type->grosir_address == '1')
            YES
          @else
            NO
          @endif
...
<div class="block">
  <div class="block-header block-header-default">
    <h3 class="block-title">Customer ({{ $customer_type->customer->count() }})</h3>
  </div>
  <div class="block-content">
    <table id="datatable" class="table table-striped table-vcenter table-responsive">
      ...
      <tbody>
        @foreach($customer_type->customer as $customer)
        <tr>
