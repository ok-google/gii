...
<nav class="breadcrumb bg-white push">
  ...
  <a class="breadcrumb-item" href="{{ route('superuser.master.brand_reference.index') }}">Brand</a>
  <span class="breadcrumb-item active">Show</span>
</nav>
<div class="block">
  <div class="block-header block-header-default">
    <h3 class="block-title">Show Brand</h3>
  </div>
...
<div class="block">
  <div class="block-header block-header-default">
    <h3 class="block-title">Sub Brand ({{ $brand_reference->sub_brand_references->count() }})</h3>
  </div>
  <div class="block-content">
    <table id="datatable" class="table table-striped table-vcenter table-responsive">
      <thead>
        <tr>
          ...
          <th class="text-center">Sub Brand</th>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="text-center">{{ $sub_brand_reference->code }}</td>
          <td class="text-center">{{ $sub_brand_reference->name }}</td>
